...
public class VerifyWebComCadastroCliente implements ISeleniumUtils {
	...
	public void VerifyValidCadastroCliente() throws IOException, InterruptedException
	{
		Util util=new Util();
		...
		ListaCadastroClientePageTest listaCliente=new ListaCadastroClientePageTest(webDriver);
		
		listaCliente.ClicaButtonAdicionarCliente();
		
		CadastroClientePageTest CadastrarCliente=new CadastroClientePageTest(webDriver);
